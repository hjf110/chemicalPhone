<template>
	<view class="uni-calendar" @touchmove.stop.prevent="clean">
		...
		<view v-if="insert || show"  :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow,'uni-calendar__content':showItem}">
			...
			<view :class="[showItem?'uni-calendar__header':'uni-calendar__header2']">
				<view class="uni-calendar__header-btn-box" @click="pre">
					<view class="uni-calendar__header-btn uni-calendar--left"></view>
				</view>
				<text @click="dateClick" class="uni-calendar__header-text">{{ (nowDate.year||'') +'年'+( nowDate.month||'') +'月'}}</text>
				<view class="uni-calendar__header-btn-box" @click="next">
					<view class="uni-calendar__header-btn uni-calendar--right"></view>
				</view>
				<text v-show="showItem" class="uni-calendar__backtoday" @click="backtoday">回到今天</text>
			</view>
			<view v-if="showItem" class="uni-calendar__box">
